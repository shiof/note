...
2. 查询Topic列表
    ...
    ~~~shell
    [root@localhost bin]# ./kafka-topics.sh --list --bootstrap-server localhost:9091
    __consumer_offsets
    test
    ~~~
...
3. 查询Topic详情（分区，副本，leader信息）
    ...
    ~~~shell
    [root@localhost bin]# ./kafka-topics.sh -describe --bootstrap-server localhost:9091 --topic test
...
4. 创建Topic
    ...
    ~~~shell
    [root@localhost bin]# ./kafka-topics.sh --create --bootstrap-server localhost:9091 --replication-factor 1 --partitions 1 --topic test1
    ~~~
 
5. 删除Topic

    ~~~shell
    [root@localhost bin]# ./kafka-topics.sh --delete --bootstrap-server localhost:9091 --topic test1
    ~~~
